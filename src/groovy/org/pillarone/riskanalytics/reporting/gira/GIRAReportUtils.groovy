...
class GIRAReportUtils {
    ...
    public
    static JRMapCollectionDataSource getPDFChartAndCommentsInfoDataSource(JRBeanCollectionDataSource comments, JRBeanCollectionDataSource values, String pageTitle) {
        Map simpleMasterMap = new HashMap();
